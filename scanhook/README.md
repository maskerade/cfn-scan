# Booking::Cloud::ScanHook

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `booking-cloud-scanhook.json`
2. Implement your resource handlers in `booking_cloud_scanhook/handlers.py`
